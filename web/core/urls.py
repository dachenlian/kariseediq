...
urlpatterns = [
    ...
    path('<str:hw>/update/', views.HeadwordUpdateView.as_view(), name='update_headword'),
    path('<str:hw>/<int:sense>/update/', views.SenseUpdateView.as_view(), name='update_sense'),
    path('<str:hw>/<int:sense>/delete/', views.SenseDeleteView.as_view(), name='delete'),
