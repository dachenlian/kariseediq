    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagging', multiselectfield.db.fields.MultiSelectField(choices=[('HAN_BORROWED', '漢語借字'), ('JP_BORROWED', '日語借字'), ('MIN_BORROWED', '閩南語借字'), ('PLANT', '植物'), ('NATURE', '自然'), ('QUANTIFIER', '計量'), ('HUNTING', '狩獵'), ('TEXTILE', '織布服飾'), ('TRANSPORTATION', '交通'), ('RELATIVE', '親屬稱謂'), ('EVERYDAY', '日常生活（含用品）'), ('ANIMAL', '動物'), ('BUILDING', '建築'), ('BODY', '身體'), ('AGRICULTURE', '農耕'), ('RELIGION', '宗教'), ('FOOD', '食物')], default='NATURE', max_length=157)),
                ...
                ('wordClass', multiselectfield.db.fields.MultiSelectField(choices=[('NOUN', '名詞'), ('VERB', '動詞'), ('MULTI', '多重詞性'), ('OTHER', '其他')], default='NOUN', max_length=21)),
